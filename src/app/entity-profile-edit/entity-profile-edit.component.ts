...
..."></textarea>
  ...
  styles: [`
    ...
    .btn-outline-primary { border: 1px solid var(--purple-primary); background: transparent; color: var(--purple-primary); width: 100%; }
    .btn-outline-primary:hover { background: var(--purple-primary); color: white; }
